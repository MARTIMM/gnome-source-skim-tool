...
my Hash $methods = %(
  ...
  #replace-data => %( :returns(gboolean), :parameters([Str, gpointer, gpointer, , ])),
  #replace-qdata => %( :returns(gboolean), :parameters([GQuark, gpointer, gpointer, , ])),
  run-dispose => %(),
