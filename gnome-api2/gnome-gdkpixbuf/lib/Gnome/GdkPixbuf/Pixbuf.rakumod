...
my Hash $methods = %(
  ...
  #get-file-info => %( :type(Function), :is-symbol<gdk_pixbuf_get_file_info>,  :returns(N-GdkPixbufFormat ), :parameters([ Str, gint-ptr, gint-ptr])),
  #get-file-info-async => %( :type(Function), :is-symbol<gdk_pixbuf_get_file_info_async>,  :parameters([ Str, N-Object, , gpointer])),
  #get-file-info-finish => %( :type(Function), :is-symbol<gdk_pixbuf_get_file_info_finish>,  :returns(N-GdkPixbufFormat ), :parameters([ N-Object, gint-ptr, gint-ptr, CArray[N-Error]])),
