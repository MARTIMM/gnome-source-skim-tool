...
enum GdkModifierType is export (
  :GDK_NO_MODIFIER_MASK(0), :GDK_SHIFT_MASK(1), :GDK_LOCK_MASK(2), :GDK_CONTROL_MASK(4), :GDK_ALT_MASK(8), :GDK_BUTTON1_MASK(256), :GDK_BUTTON2_MASK(512), :GDK_BUTTON3_MASK(1024), :GDK_BUTTON4_MASK(2048), :GDK_BUTTON5_MASK(4096), :GDK_SUPER_MASK(67108864), :GDK_HYPER_MASK(134217728), :GDK_META_MASK(268435456)
);
