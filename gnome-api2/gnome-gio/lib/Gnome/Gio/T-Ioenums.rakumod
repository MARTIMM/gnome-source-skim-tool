# Command to generate: generate.raku -v -c -t Gio ioenums
use v6.d;
...
enum GTlsChannelBindingType is export <
  G_TLS_CHANNEL_BINDING_TLS_UNIQUE G_TLS_CHANNEL_BINDING_TLS_SERVER_END_POINT 
>;
