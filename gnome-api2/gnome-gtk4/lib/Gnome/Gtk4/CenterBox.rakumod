...
my Hash $methods = %(
  ...
  get-shrink-center-last => %(:is-symbol<gtk_center_box_get_shrink_center_last>, :returns(gboolean), :cnv-return(Bool), ),
  ...
  set-shrink-center-last => %(:is-symbol<gtk_center_box_set_shrink_center_last>, :parameters([gboolean]), ),
