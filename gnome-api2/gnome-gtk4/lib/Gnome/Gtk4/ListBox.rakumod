...
my Hash $methods = %(
  ...
  remove-all => %(:is-symbol<gtk_list_box_remove_all>, ),
  ...
  set-filter-func => %(:is-symbol<gtk_list_box_set_filter_func>, :parameters([:( N-Object $row, gpointer $user-data ), gpointer, :( gpointer $data )]), ),
  set-header-func => %(:is-symbol<gtk_list_box_set_header_func>, :parameters([:( N-Object $row, N-Object $before, gpointer $user-data ), gpointer, :( gpointer $data )]), ),
  ...
  set-sort-func => %(:is-symbol<gtk_list_box_set_sort_func>, :parameters([:( N-Object $row1, N-Object $row2, gpointer $user-data ), gpointer, :( gpointer $data )]), ),
