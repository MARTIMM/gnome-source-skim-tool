...
unit class Gnome::Gtk4::ShortcutLabel:auth<github:MARTIMM>:api<2>;
...
submethod BUILD ( *%options ) {
  ...
  if self.^name eq 'Gnome::Gtk4::ShortcutLabel' {
    ...
    self._set-class-info('GtkShortcutLabel');
  }
}
...
my Hash $methods = %(
  ...
  #--[Constructors]-------------------------------------------------------------
  new-shortcutlabel => %( :type(Constructor), :isnew, :returns(N-GObject), :parameters([ Str])),
