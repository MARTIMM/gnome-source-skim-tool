...
my Hash $methods = %(
  ...
  next => %(:is-symbol<gtk_bitset_iter_next>, :returns(gboolean), :cnv-return(Bool), :parameters([guint-ptr]), ),
  previous => %(:is-symbol<gtk_bitset_iter_previous>, :returns(gboolean), :cnv-return(Bool), :parameters([guint-ptr]), ),
