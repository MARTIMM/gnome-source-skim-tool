=comment Package: Gtk4, C-Source: colorchooserwidget
use v6.d;
...
submethod BUILD ( *%options ) {
  ...
  Gnome::N::deprecate(
    'Gnome::Gtk4::ColorChooserWidget', ', Str, ',
    '4.10', Str,
...
my Hash $methods = %(
  ...
  #--[Constructors]-------------------------------------------------------------
  new-colorchooserwidget => %( :type(Constructor), :is-symbol<gtk_color_chooser_widget_new>, :returns(N-Object), ),
);
