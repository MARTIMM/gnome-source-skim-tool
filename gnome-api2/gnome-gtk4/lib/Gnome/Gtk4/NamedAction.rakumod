...
unit class Gnome::Gtk4::NamedAction:auth<github:MARTIMM>:api<2>;
...
submethod BUILD ( *%options ) {
  ...
  if self.^name eq 'Gnome::Gtk4::NamedAction' {
    ...
    self._set-class-info('GtkNamedAction');
  }
}
...
my Hash $methods = %(
  ...
  #--[Constructors]-------------------------------------------------------------
  new-namedaction => %( :type(Constructor), :isnew, :returns(N-GObject), :parameters([ Str])),
