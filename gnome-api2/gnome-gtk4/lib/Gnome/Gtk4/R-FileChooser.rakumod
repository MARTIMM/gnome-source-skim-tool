...
unit class Gnome::Gtk4::R-FileChooser:auth<github:MARTIMM>:api<2>;
...
my Hash $methods = %(
  ...
  add-shortcut-folder => %(:is-symbol<gtk_file_chooser_add_shortcut_folder>, :returns(gboolean), :parameters([N-Object, CArray[N-Error]]), :deprecated, :deprecated-version<4.10>, ),
  ...
  get-create-folders => %(:is-symbol<gtk_file_chooser_get_create_folders>, :returns(gboolean), :deprecated, :deprecated-version<4.10>, ),
  ...
  get-select-multiple => %(:is-symbol<gtk_file_chooser_get_select_multiple>, :returns(gboolean), :deprecated, :deprecated-version<4.10>, ),
  ...
  remove-shortcut-folder => %(:is-symbol<gtk_file_chooser_remove_shortcut_folder>, :returns(gboolean), :parameters([N-Object, CArray[N-Error]]), :deprecated, :deprecated-version<4.10>, ),
  ...
  set-current-folder => %(:is-symbol<gtk_file_chooser_set_current_folder>, :returns(gboolean), :parameters([N-Object, CArray[N-Error]]), :deprecated, :deprecated-version<4.10>, ),
  set-current-name => %(:is-symbol<gtk_file_chooser_set_current_name>, :parameters([Str]), :deprecated, :deprecated-version<4.10>, ),
  set-file => %(:is-symbol<gtk_file_chooser_set_file>, :returns(gboolean), :parameters([N-Object, CArray[N-Error]]), :deprecated, :deprecated-version<4.10>, ),
