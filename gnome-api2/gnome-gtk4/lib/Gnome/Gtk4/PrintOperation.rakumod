...
my Hash $methods = %(
  ...
  get-embed-page-setup => %(:is-symbol<gtk_print_operation_get_embed_page_setup>, :returns(gboolean), ),
  get-error => %(:is-symbol<gtk_print_operation_get_error>, :parameters([CArray[N-Error]]), ),
  get-has-selection => %(:is-symbol<gtk_print_operation_get_has_selection>, :returns(gboolean), ),
  ...
  get-support-selection => %(:is-symbol<gtk_print_operation_get_support_selection>, :returns(gboolean), ),
  is-finished => %(:is-symbol<gtk_print_operation_is_finished>, :returns(gboolean), ),
