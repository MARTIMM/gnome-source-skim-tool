...
my Hash $methods = %(
  ...
  activate => %(:is-symbol<gtk_widget_activate>, :returns(gboolean), ),
  activate-action => %(:is-symbol<gtk_widget_activate_action>, :variable-list, :returns(gboolean), :parameters([Str, Str]), ),
  activate-action-variant => %(:is-symbol<gtk_widget_activate_action_variant>, :returns(gboolean), :parameters([Str, N-Object]), ),
  ...
  add-tick-callback => %(:is-symbol<gtk_widget_add_tick_callback>, :returns(guint), :parameters([:( N-Object $widget, N-Object $frame-clock, gpointer $user-data ), gpointer, :( gpointer $data )]), ),
  allocate => %(:is-symbol<gtk_widget_allocate>, :parameters([gint, gint, gint, N-Object]), ),
  child-focus => %(:is-symbol<gtk_widget_child_focus>, :returns(gboolean), :parameters([GEnum]), ),
  compute-bounds => %(:is-symbol<gtk_widget_compute_bounds>, :returns(gboolean), :parameters([N-Object, N-Object]), ),
  compute-expand => %(:is-symbol<gtk_widget_compute_expand>, :returns(gboolean), :parameters([GEnum]), ),
  compute-point => %(:is-symbol<gtk_widget_compute_point>, :returns(gboolean), :parameters([N-Object, N-Object, N-Object]), ),
  compute-transform => %(:is-symbol<gtk_widget_compute_transform>, :returns(gboolean), :parameters([N-Object, N-Object]), ),
  contains => %(:is-symbol<gtk_widget_contains>, :returns(gboolean), :parameters([gdouble, gdouble]), ),
  ...
  dispose-template => %(:is-symbol<gtk_widget_dispose_template>, :parameters([GType]), ),
  drag-check-threshold => %(:is-symbol<gtk_widget_drag_check_threshold>, :returns(gboolean), :parameters([gint, gint, gint, gint]), ),
  error-bell => %(:is-symbol<gtk_widget_error_bell>, ),
  get-allocated-baseline => %(:is-symbol<gtk_widget_get_allocated_baseline>, :returns(gint), :deprecated, :deprecated-version<4.12>, ),
  get-allocated-height => %(:is-symbol<gtk_widget_get_allocated_height>, :returns(gint), :deprecated, :deprecated-version<4.12>, ),
  get-allocated-width => %(:is-symbol<gtk_widget_get_allocated_width>, :returns(gint), :deprecated, :deprecated-version<4.12>, ),
  #get-allocation => %(:is-symbol<gtk_widget_get_allocation>, :deprecated, :deprecated-version<4.12>, ),
  get-ancestor => %(:is-symbol<gtk_widget_get_ancestor>, :returns(N-Object), :parameters([GType]), ),
  get-baseline => %(:is-symbol<gtk_widget_get_baseline>, :returns(gint), ),
  get-can-focus => %(:is-symbol<gtk_widget_get_can_focus>, :returns(gboolean), ),
  get-can-target => %(:is-symbol<gtk_widget_get_can_target>, :returns(gboolean), ),
  get-child-visible => %(:is-symbol<gtk_widget_get_child_visible>, :returns(gboolean), ),
  get-clipboard => %(:is-symbol<gtk_widget_get_clipboard>, :returns(N-Object), ),
  get-color => %(:is-symbol<gtk_widget_get_color>, :parameters([N-Object]), ),
  ...
  get-focus-on-click => %(:is-symbol<gtk_widget_get_focus_on_click>, :returns(gboolean), ),
  get-focusable => %(:is-symbol<gtk_widget_get_focusable>, :returns(gboolean), ),
  get-font-map => %(:is-symbol<gtk_widget_get_font_map>, :returns(N-Object), ),
  get-font-options => %(:is-symbol<gtk_widget_get_font_options>, :returns(Cairo::cairo_font_options_t), ),
  ...
  get-has-tooltip => %(:is-symbol<gtk_widget_get_has_tooltip>, :returns(gboolean), ),
  get-height => %(:is-symbol<gtk_widget_get_height>, :returns(gint), ),
  get-hexpand => %(:is-symbol<gtk_widget_get_hexpand>, :returns(gboolean), ),
  get-hexpand-set => %(:is-symbol<gtk_widget_get_hexpand_set>, :returns(gboolean), ),
  ...
  get-mapped => %(:is-symbol<gtk_widget_get_mapped>, :returns(gboolean), ),
  ...
  get-preferred-size => %(:is-symbol<gtk_widget_get_preferred_size>, :parameters([N-Object, N-Object]), ),
  ...
  get-realized => %(:is-symbol<gtk_widget_get_realized>, :returns(gboolean), ),
  get-receives-default => %(:is-symbol<gtk_widget_get_receives_default>, :returns(gboolean), ),
  ...
  get-sensitive => %(:is-symbol<gtk_widget_get_sensitive>, :returns(gboolean), ),
  ...
  get-style-context => %(:is-symbol<gtk_widget_get_style_context>, :returns(N-Object), :deprecated, :deprecated-version<4.10>, ),
  ...
  get-vexpand => %(:is-symbol<gtk_widget_get_vexpand>, :returns(gboolean), ),
  get-vexpand-set => %(:is-symbol<gtk_widget_get_vexpand_set>, :returns(gboolean), ),
  get-visible => %(:is-symbol<gtk_widget_get_visible>, :returns(gboolean), ),
  get-width => %(:is-symbol<gtk_widget_get_width>, :returns(gint), ),
  grab-focus => %(:is-symbol<gtk_widget_grab_focus>, :returns(gboolean), ),
  has-css-class => %(:is-symbol<gtk_widget_has_css_class>, :returns(gboolean), :parameters([Str]), ),
  has-default => %(:is-symbol<gtk_widget_has_default>, :returns(gboolean), ),
  has-focus => %(:is-symbol<gtk_widget_has_focus>, :returns(gboolean), ),
  has-visible-focus => %(:is-symbol<gtk_widget_has_visible_focus>, :returns(gboolean), ),
  hide => %(:is-symbol<gtk_widget_hide>, :deprecated, :deprecated-version<4.10>, ),
  in-destruction => %(:is-symbol<gtk_widget_in_destruction>, :returns(gboolean), ),
  ...
  is-ancestor => %(:is-symbol<gtk_widget_is_ancestor>, :returns(gboolean), :parameters([N-Object]), ),
  is-drawable => %(:is-symbol<gtk_widget_is_drawable>, :returns(gboolean), ),
  is-focus => %(:is-symbol<gtk_widget_is_focus>, :returns(gboolean), ),
  is-sensitive => %(:is-symbol<gtk_widget_is_sensitive>, :returns(gboolean), ),
  is-visible => %(:is-symbol<gtk_widget_is_visible>, :returns(gboolean), ),
  keynav-failed => %(:is-symbol<gtk_widget_keynav_failed>, :returns(gboolean), :parameters([GEnum]), ),
  list-mnemonic-labels => %(:is-symbol<gtk_widget_list_mnemonic_labels>, :returns(N-Object), ),
  ...
  mnemonic-activate => %(:is-symbol<gtk_widget_mnemonic_activate>, :returns(gboolean), :parameters([gboolean]), ),
  ...
  set-font-options => %(:is-symbol<gtk_widget_set_font_options>, :parameters([Cairo::cairo_font_options_t]), ),
  ...
  should-layout => %(:is-symbol<gtk_widget_should_layout>, :returns(gboolean), ),
  show => %(:is-symbol<gtk_widget_show>, :deprecated, :deprecated-version<4.10>, ),
  ...
  translate-coordinates => %(:is-symbol<gtk_widget_translate_coordinates>, :returns(gboolean), :parameters([N-Object, gdouble, gdouble, CArray[gdouble], CArray[gdouble]]), :deprecated, :deprecated-version<4.12>, ),
