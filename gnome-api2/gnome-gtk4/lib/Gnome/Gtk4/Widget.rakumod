...
submethod BUILD ( *%options ) {
  ...
  unless $signals-added {
    self.add-signal-types( $?CLASS.^name,
      :w0<map unrealize unmap show hide destroy realize>,
      :w1<keynav-failed mnemonic-activate state-flags-changed move-focus direction-changed>,
      :w4<query-tooltip>,
    );
...
my Hash $methods = %(
  ...
  activate-action-variant => %(:is-symbol<gtk_widget_activate_action_variant>, :returns(gboolean), :cnv-return(Bool), :parameters([Str, N-Object]), ),
  ...
  compute-bounds => %(:is-symbol<gtk_widget_compute_bounds>, :returns(gboolean), :cnv-return(Bool), :parameters([N-Object, N-Object]), ),
  compute-expand => %(:is-symbol<gtk_widget_compute_expand>, :returns(gboolean), :cnv-return(Bool), :parameters([GEnum]), ),
  compute-point => %(:is-symbol<gtk_widget_compute_point>, :returns(gboolean), :cnv-return(Bool), :parameters([N-Object, N-Object, N-Object]), ),
  compute-transform => %(:is-symbol<gtk_widget_compute_transform>, :returns(gboolean), :cnv-return(Bool), :parameters([N-Object, N-Object]), ),
  ...
  translate-coordinates => %(:is-symbol<gtk_widget_translate_coordinates>, :returns(gboolean), :cnv-return(Bool), :parameters([N-Object, gdouble, gdouble, CArray[gdouble], CArray[gdouble]]), :deprecated, :deprecated-version<4.12>, ),
