...
submethod BUILD ( *%options ) {
  ...
  unless $signals-added {
    self.add-signal-types( $?CLASS.^name,
      :w0<toggle-cursor-visible copy-clipboard set-anchor backspace cut-clipboard paste-clipboard insert-emoji toggle-overwrite>,
      :w1<preedit-changed select-all insert-at-cursor>,
...
my Hash $methods = %(
  ...
  backward-display-line => %(:is-symbol<gtk_text_view_backward_display_line>, :returns(gboolean), :parameters([N-Object]), ),
  backward-display-line-start => %(:is-symbol<gtk_text_view_backward_display_line_start>, :returns(gboolean), :parameters([N-Object]), ),
  buffer-to-window-coords => %(:is-symbol<gtk_text_view_buffer_to_window_coords>, :parameters([GEnum, gint, gint, gint-ptr, gint-ptr]), ),
  forward-display-line => %(:is-symbol<gtk_text_view_forward_display_line>, :returns(gboolean), :parameters([N-Object]), ),
  forward-display-line-end => %(:is-symbol<gtk_text_view_forward_display_line_end>, :returns(gboolean), :parameters([N-Object]), ),
  get-accepts-tab => %(:is-symbol<gtk_text_view_get_accepts_tab>, :returns(gboolean), ),
  ...
  get-cursor-locations => %(:is-symbol<gtk_text_view_get_cursor_locations>, :parameters([N-Object, N-Object, N-Object]), ),
  get-cursor-visible => %(:is-symbol<gtk_text_view_get_cursor_visible>, :returns(gboolean), ),
  get-editable => %(:is-symbol<gtk_text_view_get_editable>, :returns(gboolean), ),
  ...
  get-iter-at-location => %(:is-symbol<gtk_text_view_get_iter_at_location>, :returns(gboolean), :parameters([N-Object, gint, gint]), ),
  get-iter-at-position => %(:is-symbol<gtk_text_view_get_iter_at_position>, :returns(gboolean), :parameters([N-Object, gint-ptr, gint, gint]), ),
  get-iter-location => %(:is-symbol<gtk_text_view_get_iter_location>, :parameters([N-Object, N-Object]), ),
  ...
  get-line-at-y => %(:is-symbol<gtk_text_view_get_line_at_y>, :parameters([N-Object, gint, gint-ptr]), ),
  get-line-yrange => %(:is-symbol<gtk_text_view_get_line_yrange>, :parameters([N-Object, gint-ptr, gint-ptr]), ),
  get-ltr-context => %(:is-symbol<gtk_text_view_get_ltr_context>, :returns(N-Object), ),
  get-monospace => %(:is-symbol<gtk_text_view_get_monospace>, :returns(gboolean), ),
  get-overwrite => %(:is-symbol<gtk_text_view_get_overwrite>, :returns(gboolean), ),
  ...
  get-tabs => %(:is-symbol<gtk_text_view_get_tabs>, :returns(N-Object), ),
  get-top-margin => %(:is-symbol<gtk_text_view_get_top_margin>, :returns(gint), ),
  get-visible-rect => %(:is-symbol<gtk_text_view_get_visible_rect>, :parameters([N-Object]), ),
  get-wrap-mode => %(:is-symbol<gtk_text_view_get_wrap_mode>,  :returns(GEnum), :cnv-return(GtkWrapMode)),
  im-context-filter-keypress => %(:is-symbol<gtk_text_view_im_context_filter_keypress>, :returns(gboolean), :parameters([N-Object]), ),
  move-mark-onscreen => %(:is-symbol<gtk_text_view_move_mark_onscreen>, :returns(gboolean), :parameters([N-Object]), ),
  move-overlay => %(:is-symbol<gtk_text_view_move_overlay>, :parameters([N-Object, gint, gint]), ),
  move-visually => %(:is-symbol<gtk_text_view_move_visually>, :returns(gboolean), :parameters([N-Object, gint]), ),
  place-cursor-onscreen => %(:is-symbol<gtk_text_view_place_cursor_onscreen>, :returns(gboolean), ),
  ...
  scroll-to-iter => %(:is-symbol<gtk_text_view_scroll_to_iter>, :returns(gboolean), :parameters([N-Object, gdouble, gboolean, gdouble, gdouble]), ),
  ...
  set-tabs => %(:is-symbol<gtk_text_view_set_tabs>, :parameters([N-Object]), ),
  ...
  starts-display-line => %(:is-symbol<gtk_text_view_starts_display_line>, :returns(gboolean), :parameters([N-Object]), ),
