...
enum GtkAccessibleState is export <
  GTK_ACCESSIBLE_STATE_BUSY GTK_ACCESSIBLE_STATE_CHECKED GTK_ACCESSIBLE_STATE_DISABLED GTK_ACCESSIBLE_STATE_EXPANDED GTK_ACCESSIBLE_STATE_HIDDEN GTK_ACCESSIBLE_STATE_INVALID GTK_ACCESSIBLE_STATE_PRESSED GTK_ACCESSIBLE_STATE_SELECTED GTK_ACCESSIBLE_STATE_VISITED 
>;
...
enum GtkAlign is export <
  GTK_ALIGN_FILL GTK_ALIGN_START GTK_ALIGN_END GTK_ALIGN_CENTER GTK_ALIGN_BASELINE_FILL GTK_ALIGN_BASELINE GTK_ALIGN_BASELINE_CENTER 
>;
...
enum GtkListTabBehavior is export <
  GTK_LIST_TAB_ALL GTK_LIST_TAB_ITEM GTK_LIST_TAB_CELL 
>;
...
enum GtkListScrollFlags is export (
  :GTK_LIST_SCROLL_NONE(0), :GTK_LIST_SCROLL_FOCUS(1), :GTK_LIST_SCROLL_SELECT(2)
);
