...
submethod BUILD ( *%options ) {
  ...
  Gnome::N::deprecate(
    'Gnome::Gtk4::CellRendererProgress', ', Str, ',
    '4.10', Str,
  ...
  if self.^name eq 'Gnome::Gtk4::CellRendererProgress' {
...
my Hash $methods = %(
  ...
  #--[Constructors]-------------------------------------------------------------
  new-cellrendererprogress => %( :type(Constructor), :is-symbol<gtk_cell_renderer_progress_new>, :returns(N-Object), :deprecated, :deprecated-version<4.10>, ),
);
