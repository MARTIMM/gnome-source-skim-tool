...
my Hash $methods = %(
  ...
  #--[Constructors]-------------------------------------------------------------
  new-empty => %( :type(Constructor), :is-symbol<gtk_bitset_new_empty>, :returns(N-Bitset), ),
  new-range => %( :type(Constructor), :is-symbol<gtk_bitset_new_range>, :returns(N-Bitset), :parameters([ guint, guint])),
  ...
  copy => %(:is-symbol<gtk_bitset_copy>,  :returns(N-Bitset)),
  difference => %(:is-symbol<gtk_bitset_difference>,  :parameters([N-Bitset])),
  equals => %(:is-symbol<gtk_bitset_equals>,  :returns(gboolean), :cnv-return(Bool), :parameters([N-Bitset])),
  ...
  intersect => %(:is-symbol<gtk_bitset_intersect>,  :parameters([N-Bitset])),
  is-empty => %(:is-symbol<gtk_bitset_is_empty>,  :returns(gboolean), :cnv-return(Bool)),
  ref => %(:is-symbol<gtk_bitset_ref>,  :returns(N-Bitset)),
  ...
  subtract => %(:is-symbol<gtk_bitset_subtract>,  :parameters([N-Bitset])),
  union => %(:is-symbol<gtk_bitset_union>,  :parameters([N-Bitset])),
