...
my Hash $methods = %(
  ...
  #--[Constructors]-------------------------------------------------------------
  new-varianttype => %( :type(Constructor), :is-symbol<g_variant_type_new>, :returns(N-VariantType), :parameters([ Str])),
  new-array => %( :type(Constructor), :is-symbol<g_variant_type_new_array>, :returns(N-VariantType), :parameters([ N-VariantType])),
  new-dict-entry => %( :type(Constructor), :is-symbol<g_variant_type_new_dict_entry>, :returns(N-VariantType), :parameters([ N-VariantType, N-VariantType])),
  new-maybe => %( :type(Constructor), :is-symbol<g_variant_type_new_maybe>, :returns(N-VariantType), :parameters([ N-VariantType])),
  new-tuple => %( :type(Constructor), :is-symbol<g_variant_type_new_tuple>, :returns(N-VariantType), :parameters([ CArray[N-VariantType], gint])),

  #--[Methods]------------------------------------------------------------------
  copy => %(:is-symbol<g_variant_type_copy>,  :returns(N-VariantType)),
  dup-string => %(:is-symbol<g_variant_type_dup_string>,  :returns(Str)),
  element => %(:is-symbol<g_variant_type_element>,  :returns(N-VariantType)),
  equal => %(:is-symbol<g_variant_type_equal>,  :returns(gboolean), :cnv-return(Bool), :parameters([gpointer])),
  first => %(:is-symbol<g_variant_type_first>,  :returns(N-VariantType)),
  ...
  is-subtype-of => %(:is-symbol<g_variant_type_is_subtype_of>,  :returns(gboolean), :cnv-return(Bool), :parameters([N-VariantType])),
  ...
  key => %(:is-symbol<g_variant_type_key>,  :returns(N-VariantType)),
  n-items => %(:is-symbol<g_variant_type_n_items>,  :returns(gsize)),
  next => %(:is-symbol<g_variant_type_next>,  :returns(N-VariantType)),
  peek-string => %(:is-symbol<g_variant_type_peek_string>,  :returns(Str)),
  value => %(:is-symbol<g_variant_type_value>,  :returns(N-VariantType)),
